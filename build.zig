...
pub fn build(b: *std.Build) void {
    ...
    // raygui
    // ... generate the implementation for raygui.h in raygui.c
    ...
    raygui_artifact.addIncludePath(.{ .path = "raygui/" });
    raygui_artifact.step.dependOn(&generate_file_step_raylib_c.step);

    // link raylib to raygui
    ...
    exe.addIncludePath(.{ .path = "raygui/" }); // for raygui.h in cInclude
